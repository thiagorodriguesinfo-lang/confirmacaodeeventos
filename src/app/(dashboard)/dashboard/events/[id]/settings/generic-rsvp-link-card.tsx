    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        <p className="text-sm text-muted-foreground">
          ...
          transmissão do WhatsApp em vez de um disparo individual. Só funciona para quem já está cadastrado na lista de
          convidados deste evento (pela equipe ou por importação) — quem digitar um telefone não cadastrado não consegue
          confirmar por aqui. Como não há senha/token por convidado, qualquer pessoa que souber o telefone de alguém
          consegue confirmar em nome dela.
        </p>
